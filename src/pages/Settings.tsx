...
import { Save, User, Bell, Shield, Database, Printer, Globe } from 'lucide-react';

export default function Settings() {
  const [activeTab, setActiveTab] = useState('general');
  const [settings, setSettings] = useState({
    storeName: 'MediGo Pharmacy',
    storeAddress: '123 Medical Street, Health District',
    storePhone: '+1 (555) 123-4567',
    storeEmail: 'info@medigo.com',
    currency: 'USD',
    taxRate: '10',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-500 mb-3">Create a backup of your data now</p>
            ...
            {activeTab === 'printing' && (
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-900">Printing Preferences</h3>
                <div className="space-y-4">
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <h4 className="font-medium text-gray-900 mb-2">Receipt Settings</h4>
                    <div className="space-y-3">
                      <div>
